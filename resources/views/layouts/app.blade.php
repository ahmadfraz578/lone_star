...
<title>@yield('title', 'Lone Star Solutions')</title>
...
<div class="emergency-banner">
  <div class="emergency-inner">
    ...
    <span style="color:rgba(255,255,255,.4)">·</span>
    <span style="font-size:12px;color:rgba(255,255,255,.6);font-style:italic">When Texas Needs Us</span>
  </div>
</div>
...
<nav>
  <div class="nav-inner">
    <a href="{{ route('home') }}" class="logo">
      ...
      <div class="logo-text"><span class="logo-name">Lone Star</span><span class="logo-sub">Texas Services Team</span></div>
    </a>
    ...
    <div class="nav-links" id="nav-links">
      <a href="{{ route('electrical') }}" class="nav-link {{ request()->routeIs('electrical') ? 'active' : '' }}">⚡ Electrical</a>
      <a href="{{ route('plumbing') }}" class="nav-link {{ request()->routeIs('plumbing') ? 'active' : '' }}">💧 Plumbing</a>
      <a href="{{ route('roofing') }}" class="nav-link {{ request()->routeIs('roofing') ? 'active' : '' }}">🏠 Roofing</a>
      <a href="{{ route('about') }}" class="nav-link {{ request()->routeIs('about') ? 'active' : '' }}">About</a>
      <a href="{{ route('contact') }}" class="nav-link {{ request()->routeIs('contact') ? 'active' : '' }}">Contact</a>
    </div>
    <div class="nav-ctas">
      <a href="{{ route('quote') }}" class="btn-orange">
...
<footer>
  <div class="footer-grid">
    <div>
      <div class="footer-logo"><div class="footer-logo-star"><svg viewBox="0 0 24 24" fill="#fff"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div><div><span style="font-family:'Oswald',sans-serif;font-weight:700;color:#fff;font-size:18px;letter-spacing:.05em;text-transform:uppercase;display:block">Lone Star</span><span style="font-family:'Oswald',sans-serif;color:var(--orange);font-size:10px;letter-spacing:.15em;text-transform:uppercase">Texas Services Team</span></div></div>
      <p class="footer-about">Texas’s trusted electrical, plumbing, and roofing team. Licensed, insured, and bonded. Serving the whole Texas area with dependable, fast-response service.</p>
    ...
    <div>
      ...
      <div class="footer-links">
        <a href="{{ route('electrical') }}" class="footer-link">Electrical Services</a>
        <a href="{{ route('plumbing') }}" class="footer-link">Plumbing Services</a>
        <a href="{{ route('roofing') }}" class="footer-link">Roofing Services</a>
        <a href="{{ route('quote') }}" class="footer-link">Get a Free Quote</a>
      </div>
    </div>
    <div>
      <h3>Whole Texas Area</h3><div class="footer-accent"></div>
      <p style="color:#888;font-size:13px;line-height:1.65;max-width:340px">Statewide coverage across Texas for industrial and residential service calls.</p>
    </div>
    <div>
      ...
      <div class="footer-contact-item"><div class="footer-contact-icon" style="background:rgba(232,98,42,.15)"><svg viewBox="0 0 24 24" fill="none" stroke="#E8622A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22 6 12 13 2 6"/></svg></div><div><span class="footer-contact-label">Email</span><div class="footer-contact-val"><a href="mailto:info@lonestarsol.com" style="font-size:12px">info@lonestarsol.com</a></div></div></div>
  ...
  <div class="footer-bottom"><p>© 2025 Lone Star Solutions · Texas · All rights reserved.</p><p style="color:#555;font-size:12px">Licensed · Insured · Bonded</p></div>
</footer>
