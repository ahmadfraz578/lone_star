<?php $__env->startSection('title', 'Lone Star Solutions — Electrical, Plumbing & Roofing Across Texas'); ?>
...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-ctas">
      <a href="<?php echo e(route('quote')); ?>" class="btn-hero-orange">Get a Free Quote <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
...
<section class="section warm">
  <div class="section-inner">
    ...
    <div class="cards-grid">
      <a href="<?php echo e(route('electrical')); ?>" class="service-card">
      ...
      <a href="<?php echo e(route('plumbing')); ?>" class="service-card">
      ...
      <a href="<?php echo e(route('roofing')); ?>" class="service-card">
  ...
  <div class="section-inner">
    ...
    <div class="review-card-wrap">
      <div class="review-card" id="review-card">
        ...
        <div class="review-service-badge" id="r-service">Panel Upgrade</div>
        <p class="review-text" id="r-text">"My 100-amp panel had been tripping breakers every time we ran the AC and the dishwasher at the same time. I called Lone Star on a Thursday morning and they had a crew at my Katy home by Friday afternoon. They upgraded to a 200-amp panel, pulled all the permits, scheduled the inspection — I didn't have to do a single thing. Passed inspection first try."</p>
        <div class="review-footer">
          <div class="reviewer-info"><div class="reviewer-avatar" id="r-initials">MT</div><div><div class="reviewer-name" id="r-name">Marcus T.</div><div class="reviewer-loc" id="r-loc">Katy, TX · 3 months ago</div></div></div>
          <div style="display:flex;gap:8px">
            <button id="prev-review" style="width:40px;height:40px;border-radius:50%;border:2px solid #eee;background:none;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:border-color .2s"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#999" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg></button>
            <button id="next-review" style="width:40px;height:40px;border-radius:50%;border:2px solid #eee;background:none;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:border-color .2s"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#999" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg></button>
          </div>
        </div>
      </div>
...
<section class="section warm">
  <div class="section-inner">
    <div class="section-head"><div class="accent-line"></div><h2 class="sh">GETTING HELP IS SIMPLE</h2><p class="sh-sub">Three steps. No confusion. No runaround. Just a licensed professional showing up and fixing the problem.</p></div>
    <div class="steps-grid">
      <div class="step"><div class="step-icon-wrap"><div class="step-circle"><svg viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13.5a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 3h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 10.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 17z"/></svg></div><div class="step-num">1</div></div><div class="step-big-num">01</div><div class="step-content"><div class="step-title">Call or Request a Quote</div><p class="step-body">Call (713) 000-0000 or submit our quick online form. We'll call back within 2 hours. Emergency? We answer immediately, any hour.</p></div></div>
      <div class="step"><div class="step-icon-wrap"><div class="step-circle"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></div><div class="step-num">2</div></div><div class="step-big-num">02</div><div class="step-content"><div class="step-title">We Diagnose and Explain</div><p class="step-body">A licensed professional arrives on-site, diagnoses the problem, and explains your options with upfront pricing. No pressure. No upsells.</p></div></div>
      <div class="step"><div class="step-icon-wrap"><div class="step-circle"><svg viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg></div><div class="step-num">3</div></div><div class="step-big-num">03</div><div class="step-content"><div class="step-title">We Fix It, You Approve</div><p class="step-body">We do the work, you approve every step. We clean up completely before leaving and follow up within 48 hours. Every job backed by our 1-year labor warranty.</p></div></div>
    </div>
  </div>
</section>
...
<div class="home-cta">
  <div class="home-cta-inner">
    ...
    <div class="cta-btns">
      <a href="<?php echo e(route('quote')); ?>" class="btn-hero-orange">Get Your Free Quote <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ahmad/Downloads/new lone star/lone_star/resources/views/pages/home.blade.php ENDPATH**/ ?>