<div class="quote-section"><div class="quote-grid">
  <div><div style="margin-bottom:32px"><div class="accent-line left"></div><h2 class="sh light">GET YOUR FREE QUOTE</h2><p class="sh-sub light">We'll call back within 2 hours. For emergencies, call us directly.</p></div>
    <form action="<?php echo e(route('quote.submit')); ?>" method="POST" enctype="multipart/form-data" class="form-fields">
      <?php echo csrf_field(); ?>
      ...
      <div class="field-row"><div class="field"><label>Email *</label><input type="email" name="email" placeholder="jane@example.com" required/></div><div class="field"><label>Service Type *</label><select name="service_type" required><option value="" disabled <?php echo e(!isset($serviceType) ? 'selected' : ''); ?>>Select a service...</option><option value="Electrical" <?php echo e(isset($serviceType) && $serviceType == 'Electrical' ? 'selected' : ''); ?>>Electrical</option><option value="Plumbing" <?php echo e(isset($serviceType) && $serviceType == 'Plumbing' ? 'selected' : ''); ?>>Plumbing</option><option value="Roofing" <?php echo e(isset($serviceType) && $serviceType == 'Roofing' ? 'selected' : ''); ?>>Roofing</option></select></div></div>
      ...
      <div class="field-row"><div class="field"><label>Property Address *</label><input type="text" name="address" placeholder="123 Main St, TX" required/></div><div class="field"><label>ZIP Code *</label><input type="text" name="zip" placeholder="77001" maxlength="5" required/></div></div>
      <div class="field">
        <label>Preferred Callback Time</label>
        <input type="hidden" name="preferred_callback_time" id="preferred_callback_time" value="Morning"/>
        <div class="callback-options">
          <div class="callback-opt selected" data-callback="Morning"><span class="callback-opt-label">Morning</span><span class="callback-opt-sub">7AM – 12PM</span></div>
          <div class="callback-opt" data-callback="Afternoon"><span class="callback-opt-label">Afternoon</span><span class="callback-opt-sub">12PM – 5PM</span></div>
          <div class="callback-opt" data-callback="Evening"><span class="callback-opt-label">Evening</span><span class="callback-opt-sub">5PM – 7PM</span></div>
        </div>
      </div>
      <div class="field">
  ...
  <div class="trust-panel"><div class="call-box"><div class="call-box-label">Emergency? Don't wait.</div><a href="tel:7130000000" class="call-box-num">📞 (713) 000-0000</a><div class="call-box-sub">We answer 24/7</div></div><div class="trust-list"><p style="font-family:'Oswald',sans-serif;font-weight:600;text-transform:uppercase;letter-spacing:.06em;color:#fff;font-size:13px;margin-bottom:4px">What you can expect:</p><div class="trust-list-item"><div class="trust-check"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div><div class="trust-list-text">We call back within 2 hours</div></div><div class="trust-list-item"><div class="trust-check"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div><div class="trust-list-text">Licensed professional on every job</div></div><div class="trust-list-item"><div class="trust-check"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div><div class="trust-list-text">Upfront pricing — no surprises</div></div><div class="trust-list-item"><div class="trust-check"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg></div><div class="trust-list-text">Whole Texas area service coverage</div></div></div></div>
</div></div>
<?php /**PATH /home/ahmad/Downloads/new lone star/lone_star/resources/views/pages/partials/quote-form.blade.php ENDPATH**/ ?>